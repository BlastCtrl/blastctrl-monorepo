...
export const createInstructionData = struct<CreateInstructionData>([
  u8("instruction"),
]);
export const createIdempotentInstructionData =
  struct<CreateIdempotentInstructionData>([u8("instruction")]);
export const recoverNestedInstructionData =
  struct<RecoverNestedInstructionData>([u8("instruction")]);
