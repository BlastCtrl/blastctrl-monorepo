...
export default function Nfts() {
  const navigation = [
    {
      ...
      description:
        "Update an NFT by replacing the on-chain fields that you wish to change.",
      active: true,
    },
    {
      ...
      description:
        "Manually enter the on-chain stored information to mint an NFT.",
      active: true,
    },
    {
      name: "Burn NFT",
  ...
  return (
    <>
      <h1 className="pb-4">
        Tools for interacting with Metaplex smart contracts
      </h1>
